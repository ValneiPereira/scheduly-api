...
public record BookingResponse(
    ...
    @Schema(description = "Nome do serviço", example = "Corte de Cabelo") String serviceName,

    @Schema(description = "Categoria do serviço", example = "BELEZA") String serviceCategory,

    @Schema(description = "Preço em centavos", example = "4500") Integer priceCents,
